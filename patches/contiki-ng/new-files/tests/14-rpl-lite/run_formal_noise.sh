...
OUT_DIR="${PAPER_OUT_DIR:-$ROOT/paper-results-noise}"
...
require_csc "$GEN_DIR/s4_noise_20.csc"
require_csc "$GEN_DIR/s4_noise_40.csc"
require_csc "$GEN_DIR/s4_noise_60.csc"
